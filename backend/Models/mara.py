...
class MaraModel(db.Model):
    ...
    def json(self):
        return {'id': self.id, 'mara_nr': self.mara_nr, 'mat_desc': self.mat_desc, 'mat_int_desc': self.mat_int_desc, 'mat_rw': self.mat_rw, 't_fam_id': self.t_fam_id, 'campus_fam': self.campus_fam, 'user_id': self.user_id,
                't_mara_art_id': self.t_mara_art_id, 'upload_kind': self.upload_kind, 'dichte_trocken': self.dichte_trocken, 'dichte_konditioniert': self.dichte_konditioniert, 'unit': self.unit, 'del_kz': self.del_kz,
                'producer': self.producer, 'Verarbeitungsmethode': self.Verarbeitungsmethode,
                'Belastung_trocken': self.Belastung_trocken, 'Belastung_konditioniert': self.Belastung_konditioniert,
                'Temperatur_trocken': self.Temperatur_trocken, 'Temperatur_konditioniert': self.Temperatur_koni,
                'MVR_trocken': self.MVR_trocken, 'MVR_konditioniert': self.MVR_konditioniert,
                'Bruchdehnung_trocken': self.Bruchdehnung_trocken, 'Bruchdehnung_konditioniert': self.Bruchdehnung_konditioniert,
                'Bruchdehnung_Nominell_trocken': self.Bruchdehnung_Nominell_trocken,
                'Bruchdehnung_Nominell_konditioniert': self.Bruchdehnung_Nominell_konditioniert,
                'Bruchdehnung_TPE_trocken': self.Bruchdehnung_TPE_trocken, 'Bruchdehnung_TPE_konditioniert': self.Bruchdehnung_TPE_konditioniert,
                'Bruchdehnung_Senkrecht_trocken': self.Bruchdehnung_Senkrecht_trocken, 'Bruchdehnung_Senkrecht_konditioniert': self.Bruchdehnung_Senkrecht_konditioniert,
                'Bruchdehnung_Parallel_trocken': self.Bruchdehnung_Parallel_trocken, 'Bruchdehnung_Parallel_konditioniert': self.Bruchdehnung_Parallel_konditioniert,
                'Bruchspannung_MPa_trocken': self.Bruchspannung_MPa_trocken, 'Bruchspannung_MPa_konditioniert': self.Bruchspannung_MPa_konditioniert,
                'Bruchspannung_TPE_MPa_trocken': self.Bruchspannung_TPE_MPa_trocken, 'Bruchspannung_TPE_MPa_konditioniert': self.Bruchspannung_TPE_MPa_konditioniert,
                'Bruchspannung_Parallel_MPa_trocken': self.Bruchspannung_Parallel_MPa_trocken,
                'Bruchspannung_Parallel_MPa_konditioniert': self.Bruchspannung_Parallel_MPa_konditioniert,
                'Bruchspannung_Senkrecht_Mpa_trocken': self.Bruchspannung_Senkrecht_Mpa_trocken,
                'Bruchspannung_Senkrecht_Mpa_konditioniert': self.Bruchspannung_Senkrecht_Mpa_konditioniert,
                'Zugmodul_MPa_trocken': self.Zugmodul_MPa_trocken, 'Zugmodul_MPa_konditioniert': self.Zugmodul_MPa_konditioniert,
                'Zugmodul_Kriech_1h_MPa_trocken': self.Zugmodul_Kriech_1h_MPa_trocken, 'Zugmodul_Kriech_1h_MPa_konditioniert': self.Zugmodul_Kriech_1h_MPa_konditioniert,
